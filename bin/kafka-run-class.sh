...
for file in $base_dir/project/boot/scala-2.9.1/lib/*.jar;
do
  CLASSPATH=$CLASSPATH:$file
done

for file in $base_dir/core/target/scala_2.9.1/*.jar;
do
  CLASSPATH=$CLASSPATH:$file
done
...
for file in $base_dir/core/lib_managed/scala_2.9.1/compile/*.jar;
do
